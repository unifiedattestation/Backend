...
import OemDevices from "../../sections/oem/Devices";
...
export default function OemDevicesPage() {
  ...
  return (
    <OemMenu activeItem="devices" organizationName={organizationName} onLogout={logout}>
      <OemDevices onOrganizationLoaded={handleOrganizationLoaded} />
    </OemMenu>
  );
}
